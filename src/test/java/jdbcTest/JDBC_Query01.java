...
public class JDBC_Query01 {
    ...
    /* Bir JDBC sorgusu yapilmak istendiginde yapilacak ilk is Database
    yöneticisi ile iletisime gecerek ilgili Database'in Access'lerini
    almak olacaktir.
     */
    ...
    public static void main(String[] args) throws ClassNotFoundException, SQLException {
        ...
        // 1.ADIM: Kullanilacak veritabani icin dogru sürücüyü ekle
        Class.forName("com.mysql.cj.jdbc.Driver");

        // 2.ADIM: Veritabani ile iletisimi baslat
        ...
        // Database bir yazilimin en hassas bolümüdür.
